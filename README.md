# BleExplorer Project for Mobile Applications
...
other) in the BleExplorer-Core library. 
...
Here are some things that belong in BleExplorer-Core:
...
So, it's important that BleExplorer-Core not do platform-specific things - if
you're talking about CGRects in a BleExplorer-Core class, you're Doing It Wrong™.

Here are some things that will end up in BleExplorer-{Platform}
...
1. Create a new ViewModel class in BleExplorer-Core and derive it from
